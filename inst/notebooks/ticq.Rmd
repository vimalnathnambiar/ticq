...
# Validate input path
jsonFileCount <- length(ticq::retrieveFileList(inputPath = inputPath, fileExtension = "JSON"))
if (jsonFileCount == 0) {
...
if (length(metadataAnonymiser) != 1 || !is.logical(metadataAnonymiser) || is.na(metadataAnonymiser)) {
  stop("Invalid 'metadataAnonymiser': Must be a logical value of length 1 (TRUE or FALSE)")
}
